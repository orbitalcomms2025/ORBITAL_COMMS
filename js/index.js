...
// Cerrar modal y quitar Star Mode
...
function showWelcomeMessage(name) {
  welcomeMessage.innerHTML = `Welcome, <strong>${name}</strong>! At the bottom of the page, you can fill out a survey to help us improve our services.`;
...
loginForm.addEventListener("submit", async e => {
  ...
  try {
    ...
    if(res.ok){ 
      ...
      const name = data.name || await getUserName(email);
